...
const L1_USER_URL    = `https://docs.google.com/spreadsheets/d/${L1_ID}/export?format=csv&gid=1862078090`; // USER
const L1_FINAL_URL   = `https://docs.google.com/spreadsheets/d/${L1_ID}/export?format=csv&gid=1865245414`; // FINAL
...
const L2_RESULTS_URL = `https://docs.google.com/spreadsheets/d/${L1_ID}/export?format=csv&gid=2058890972`; // LEVEL2 (inside L1 Spreadsheet)
const L2_USER_URL    = `https://docs.google.com/spreadsheets/d/${L2_ID}/export?format=csv&gid=2099999858`; // USER
const L2_FINAL_URL   = `https://docs.google.com/spreadsheets/d/${L2_ID}/export?format=csv&gid=712456037`;  // FINAL
